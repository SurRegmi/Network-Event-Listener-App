...
// the Listener object.
// It will receive the  cluster details from the event consumer &
// initialize the WebhooksListener after validating the cluster details
// (whether the credentials are correct etc.)
//
// Args:
//    ip : External IP address of the  cluster.
//    port : Port of the  cluster (Prism port)
//    username : Username for authentication to the  cluster.
//    password : Password for authentication to the  cluster.
// Returns:
...
// This method allows the event consumer to register itself with the 
