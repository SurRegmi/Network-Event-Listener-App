...
// The Listener interface is implemented by the company provided webhook
// listener library. This library simplifies the process of registering for
// webhook events with a company AHV cluster. The event consumer that uses this
...
type Listener interface {
  ...
  // the Listener object. It will receive the company cluster details from the
  // event consumer and initialize the listener after validating the cluster
  // details (whether the credentials are correct etc.)
  //
  // Args:
  //    ip : External IP address of the company cluster.
  //    port : Port of the company cluster (Prism port)
  //    username : Username for authentication to the company cluster.
  //    password : Password for authentication to the company cluster.
  // Returns:
  ...
  // This method allows the event consumer to register itself with the company
