...
func main() {
  ...
  webhooksListener, err = webhooksListener.Initialize(
    pafwConfig.companyClusterConfig.IP,
    pafwConfig.companyClusterConfig.Port,
    pafwConfig.companyClusterConfig.Username,
    pafwConfig.companyClusterConfig.Password)
  if (err != nil) {
